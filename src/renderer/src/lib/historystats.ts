...
import { playedMs } from '@shared/playtime'
...
// Moved to `shared/` so the watchlist ordering, which main now uses too, can
// reach it; re-exported so this module's callers see no change.
export { MAX_CREDIBLE_PLAY_MS, playedMs } from '@shared/playtime'
